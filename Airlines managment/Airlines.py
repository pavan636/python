...
root=Tk()
root.title("intro")
con=sqlite3.Connection('Airindia_db')
cur=con.cursor()
...
a=PhotoImage(file="pavan.jpg")
Label(fr1,image=a).pack()
fr2=Frame()
fr2.pack(side=LEFT,expand=1)
Label(fr2,text="JUET",font=("algerian",38),compound="center",fg="Orange").pack()
Label(fr2,text="pavan kumar b",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
Label(fr2,text="151385 ",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
Label(fr2,text="B-5",font=("Bauhaus 93",14),compound="center",fg="Red").pack()
Label(fr2,text="pavanbkumar636@gmail.com",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
def airline():
    root.destroy()
    root1=Tk()
    ...
    Label(root1,text="Welcome to Air India",font=("Bauhaus 93",17),fg="Red",width=46,bg="White").grid(row=0,column=0,columnspan=4)
    ...
    def signup():
                 ...
                 Label(root,text="Welcome to Air India",font=("Bauhaus 93",17),fg="Red",width=46,bg="White").grid(row=0,column=0,columnspan=4)
                 ...
                 def signin():
                     ...
                     Label(root2,text="Welcome to Air India",font=("Bauhaus 93",17),fg="Red",width=46,bg="White").grid(row=0,column=0,columnspan=4)
                     ...
                     def bookingportal():
                          ...
                          if a==[]:
                                ...
                                Label(root4,text="Welcome to Air India",font=("Bauhaus 93",17),fg="Red",width=46,bg="White").grid(row=0,column=0,columnspan=4)
                                ...
                                Label(root4,text="Passenger1",font=("Bauhaus 93",14),fg="Blue").grid(row=8,column=1)
                                name1=Entry()
                                name1.grid(row=8,column=2)
                                Label(root4,text="Enter Your age",font=("Bauhaus 93",14),fg="Blue").grid(row=9,column=1)
                                age1=Entry(width=4)
                                ...
                                Label(root4,text="Passenger2",font=("Bauhaus 93",14),fg="Blue").grid(row=11,column=1)
                                name2=Entry()
                                name2.grid(row=11,column=2)
                                Label(root4,text="Enter Your age",font=("Bauhaus 93",14),fg="Blue").grid(row=12,column=1)
                                age2=Entry(width=4)
                                ...
                                Label(root4,text="Passenger3",font=("Bauhaus 93",14),fg="Blue").grid(row=14,column=1)
                                name3=Entry()
                                name3.grid(row=14,column=2)
                                Label(root4,text="Enter Your age",font=("Bauhaus 93",14),fg="Blue").grid(row=15,column=1)
                                age3=Entry(width=4)
                                ...
                                def data():
                                        ...
                                        Label(root5,text="Thanks For Choosing Air India",font=("Bauhaus 93",17),fg="White",bg="red",width=46).grid(row=0,column=0,columnspan=4)
    ...
    Button(root1,text="Show Flights",font=("algerian",10),fg="white",bg="Orange",compound="center",command=flights).grid(row=6,columnspan=5)
    root1.mainloop()
